...
MODEL_NAME = 'jaykun_inference_graph' #这里做了修改
...
MODEL_NAME = 'jaykun_inference_graph'
#MODEL_FILE = MODEL_NAME + '.tar.gz'
#DOWNLOAD_BASE = 'http://download.tensorflow.org/models/object_detection/'
...
#TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpg'.format(i)) for i in range(1, 3) ]
TEST_IMAGE_PATHS = os.listdir('D:\\workspace\\ssdmodels\\models-master\\models-master\\test\\testimage')
os.chdir('D:\\workspace\\ssdmodels\\models-master\\models-master\\test\\testimage')
